    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-800 transition-colors duration-200">
      ...
      <section className="relative bg-gradient-to-r from-green-400 to-blue-500 text-white py-20 dark:from-green-600 dark:to-blue-700">
        ...
        <div className="container mx-auto text-center relative px-4 z-10">
          ...
          <p className="text-xl mb-8 mx-auto max-w-2xl">Guía completa para entender, cuidar y disfrutar de tu compañero canino</p>
        </div>
      </section>
      ...
      <main className="container mx-auto px-4 py-12 z-10 relative">
        ...
        <section className="bg-white p-8 rounded-xl shadow-md dark:bg-gray-700 mb-12 fade-in">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-4">
            Adoptar un perro es una de las decisiones más gratificantes que puedes tomar. Los perros ofrecen compañía incondicional, 
            lealtad y amor sin límites. Además, al adoptar estás dando una segunda oportunidad a un animal que lo necesita.
          </p>
          <p className="text-gray-600 dark:text-gray-300">
            Los estudios demuestran que tener un perro puede mejorar tu salud física y mental, reduciendo el estrés, 
            la ansiedad y promoviendo un estilo de vida más activo.
          </p>
        </section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-md dark:bg-gray-700">
              ...
              <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-300">
                <li>Proporciona alimento de calidad adecuado a su edad, tamaño y nivel de actividad</li>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md dark:bg-gray-700">
              <h3 className="font-semibold text-xl mb-3 text-gray-800 dark:text-white">Ejercicio</h3>
              <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-300">
                ...
                <li>El ejercicio regular previene problemas de comportamiento</li>
              </ul>
            </div>
        ...
        <section className="bg-white p-8 rounded-xl shadow-md dark:bg-gray-700 mb-12 fade-in">
          <h2 className="text-2xl font-bold mb-4 text-gray-800 dark:text-white">Entrenamiento básico</h2>
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            El entrenamiento es esencial para una convivencia armoniosa con tu perro. Utiliza siempre el refuerzo positivo 
            y la paciencia como base de cualquier entrenamiento.
          </p>
          
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-blue-50 p-4 rounded-lg dark:bg-gray-600">
              <h3 className="font-semibold text-lg mb-2 text-gray-800 dark:text-white">Socialización</h3>
              <p className="text-gray-600 dark:text-gray-300">Expón a tu perro desde cachorro a diferentes personas, animales y situaciones para que desarrolle confianza.</p>
            </div>
            
            <div className="bg-blue-50 p-4 rounded-lg dark:bg-gray-600">
              <h3 className="font-semibold text-lg mb-2 text-gray-800 dark:text-white">Comandos básicos</h3>
              <p className="text-gray-600 dark:text-gray-300">Enseña comandos como "sentado", "quieto", "ven" y "suelta" para garantizar su seguridad y control.</p>
            </div>
            
            <div className="bg-blue-50 p-4 rounded-lg dark:bg-gray-600">
              <h3 className="font-semibold text-lg mb-2 text-gray-800 dark:text-white">Paseo con correa</h3>
              <p className="text-gray-600 dark:text-gray-300">Entrena a tu perro para caminar correctamente con correa sin tirar, utilizando recompensas y consistencia.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12 fade-in">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-md dark:bg-gray-700">
              <h3 className="font-semibold text-xl mb-3 text-gray-800 dark:text-white">Labrador Retriever</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-3">Amigable, activo y excelente con niños. Necesita ejercicio regular y es fácil de entrenar.</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">Esperanza de vida: 10-12 años</p>
            </div>
            
            <div className="bg-white p-6 rounded-xl shadow-md dark:bg-gray-700">
              <h3 className="font-semibold text-xl mb-3 text-gray-800 dark:text-white">Pastor Alemán</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-3">Inteligente, leal y versátil. Excelente perro de trabajo y protector de la familia.</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">Esperanza de vida: 9-13 años</p>
            </div>
            
            <div className="bg-white p-6 rounded-xl shadow-md dark:bg-gray-700">
              <h3 className="font-semibold text-xl mb-3 text-gray-800 dark:text-white">Bulldog Francés</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-3">Juguetón, alerta y adaptable. Ideal para apartamentos y familias.</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">Esperanza de vida: 10-12 años</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-gradient-to-r from-blue-500 to-green-500 text-white p-8 rounded-xl shadow-md mb-12 fade-in dark:from-blue-700 dark:to-green-700">
          ...
          <p className="mb-6">
            Si después de leer esta información estás decidido a adoptar un perro, te invitamos a explorar nuestros perros disponibles 
